...
const UserList = () => {
  ...
  if (loading) return <div className="text-2xl text-gray-800">Loading users...</div>;
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <button onClick={refetchList} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        Refresh List
      </button>
